		 ...
		 <div class="box box-info">
				...
				<table ng-show="table" class="table-hover table table-responsive table-bordered data">
					...
					<tbody id="hasil">	
						...
						<tr class="soft daftar text-capitalize  text-left" ng-repeat="data in kantin">
						
							<td>{{data.nama_kantin}}</td>
							<td>{{data.nama_lengkap}} </td>
							<td class="text-center">
								<span class="kotak-kecil">
								<a class="soft badge btn tulisan" href="kantin/edit/{{data.id_kantin}}"  >
								<span class="fa fa-pencil "></span><span class="tulisantext">Edit</span>
								</a></span>
							
								<span class="kotak-kecil">
								<a class="soft badge btn tulisan" ng-click="del(data.id_kantin)"  >
