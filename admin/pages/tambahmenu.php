		 ...
		 <div class="box box-info">
				...
				<form  name="input" action="" method="POST" enctype="multipart/form-data" >
					<div class="form-group row">
						...
						<input required type="text"  class="form-control" name="nama_menu"  placeholder="Input nama menu">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-xs-12" >
						   <div class="file-upload btn btn-block btn-success">		
								...
								<input accept="image/*" onchange="loadFile(event)" required id="uploadBtn" name="gambar" type="file" class="upload" />
							</div>
						</div>
					</div>	
					<script>
  var loadFile = function(event) {
    ...
    output.src = URL.createObjectURL(event.target.files[0]);
					...
					<div class="form-group row">
						...
						<input required type="text"  id="harga" class="form-control" name="harga"  placeholder="Input harga">
