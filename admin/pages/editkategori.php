		 ...
		 <div class="box box-info">
				...
				<form name="input" action="" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group row">
						...
						<div class="col-xs-9">
							<input required type="text"  class="form-control" name="nama_kategori" value="<?php echo $nama_kategori ?>"  placeholder="Input Kategori">
						</div>
					</div>
					 ...
					 <div class="form-group pull-right">
						...
						<a href="<?php echo link ?>/home#/kategori"   class="btn btn-danger"  >Tutup</a>
					</div>
